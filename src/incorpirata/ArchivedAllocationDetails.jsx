      ...
      <table>
        <tr>
          ...
          {manualAllocation === true ? (
            <Fragment>
              ...
              <th scope="col">Subscribed capital</th>
                  ...
                  <td>
                    <Label>
                      {numberFormatter.format(
                        relevantAllocation.subscribedCapital
                      )}
                    </Label>
                  </td>
                  <td>
        ...
        <tr key="total">
          ...
          {manualAllocation === true ? (
            <Fragment>
              <td>
                <Label>{numberFormatter.format(totals.subscribedShares)}</Label>
              </td>
              <td>
                <Label>
                  {numberFormatter.format(totals.subscribedCapital)}
                </Label>
              </td>
              <td>
                <Label>{numberFormatter.format(totals.paidUpAmount)}</Label>
              </td>
              <td>
                <Label>{totals.percentageOfOwnership}%</Label>
              </td>
            </Fragment>
          ) : (
            <Fragment>
